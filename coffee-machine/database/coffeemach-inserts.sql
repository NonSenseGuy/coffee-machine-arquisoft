...
truncate ingrediente cascade;

truncate receta cascade;

truncate receta_ingrediente cascade;

truncate alarma cascade;

truncate maquina cascade;

truncate alarma_maquina cascade;

truncate operadores cascade;

truncate asignacion_maquina cascade;
...
insert into alarma_maquina (id_alarma,id_maquina,fecha_inicial,fecha_final,consecutivo) values (1,1,current_date,null,1);

insert into alarma_maquina (id_alarma,id_maquina,fecha_inicial,fecha_final,consecutivo) values (2,5,current_date,null,2);

insert into alarma_maquina (id_alarma,id_maquina,fecha_inicial,fecha_final,consecutivo) values (3,1,current_date,null,3);

insert into alarma_maquina (id_alarma,id_maquina,fecha_inicial,fecha_final,consecutivo) values (4,3,current_date,null,4);

insert into alarma_maquina (id_alarma,id_maquina,fecha_inicial,fecha_final,consecutivo) values (1,1,current_date,null,5);
